...
> 2026-08-24 已在 X5/cv182x、固件 3.4.6、逻辑分辨率 800×254 上完成自适应版安装、启动、准备页、关于弹窗、驾驶、油门、金币拾取及 HUD/地形/控制栏回归。证据位于 `releases/adaptive-1.3.0/`。其他 Falcon 型号仍属于兼容候选，不代表已经逐机验证。
